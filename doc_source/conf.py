...
project = u'libcomcat Documentation'
copyright = u'2017, Mike Hearne'
...
htmlhelp_basename = 'libcomcatdoc'
...
intersphinx_mapping = {'python': ('https://docs.python.org/3.6', 'objects.inv')}
